...
-- 기초 데이터 (사용자)
INSERT INTO USER_T VALUES(USER_SEQ.NEXTVAL, 'admin@example.com', 'admin', '관리자', 'man', '010-1111-1111', 1, 0, CURRENT_DATE, CURRENT_DATE);
INSERT INTO USER_T VALUES(USER_SEQ.NEXTVAL, 'test1', 'test1', 't1', 'woman', '010-1111-1111', 1, 0, CURRENT_DATE, CURRENT_DATE);
INSERT INTO USER_T VALUES(USER_SEQ.NEXTVAL, 'test2', 'test2', 't2', 'man', '010-1111-1111', 1, 0, CURRENT_DATE, CURRENT_DATE);
