...
-- 기초 데이터 (사용자)
INSERT INTO USER_T
VALUES (USER_SEQ.NEXTVAL, 'admin@example.com', 'admin', '관리자', 'man', '010-1111-1111', 1, 0, CURRENT_DATE,
        CURRENT_DATE);
COMMIT;



--STANDARD_HASH('admin', 'SHA256');
...
CREATE OR REPLACE TRIGGER LEAVE_TRIGGER
    ...
    FOR EACH ROW
BEGIN
    INSERT INTO LEAVE_USER_T ( LEAVE_USER_NO
                             , EMAIL
                             , LEAVE_DT)
    VALUES ( LEAVE_USER_SEQ.NEXTVAL
           , :OLD.EMAIL
           , CURRENT_DATE);
