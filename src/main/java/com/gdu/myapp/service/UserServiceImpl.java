...
public class UserServiceImpl implements UserService {
    ...
    public String getNaverLoginAccessToken(HttpServletRequest request) {
        ...
        String clientId = "h7HITARz4dvCYr6okwC7";
        String clientSecret = "eI0R63eOKF";
    ...
    public UserDto getNaverLoginProfile(String accessToken) {
        ...
        try {
            ...
            user = UserDto.builder()
                    ...
                    .userNo(0).eventAgree(0).signupKind(0).build();
    ...
    @Override
    public void naverSignin(HttpServletRequest request, HttpServletResponse response, UserDto naverUser) {

    }

    @Override
    public void naverSignout(HttpServletRequest request, HttpServletResponse response) {
